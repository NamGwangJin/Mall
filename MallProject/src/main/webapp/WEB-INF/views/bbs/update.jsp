...
<div class="myp-form-wrap">
	...
	<div class="myp-form-col">
		<div class="input-group inline">
			...
			<input type="text" class="inputcolor" name="hp_tail1" id=num readonly value="${bPost.num}">
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">작성자</label>
			<div class="control-field">
			<input type=text class="inputcolor" name="hp_tail1" id=title value="${bPost.writer}" readonly>
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">조회수</label>
			<div class="control-field">
			<input type=text class="inputcolor" name="hp_tail1" id=title value="${bPost.hit}" readonly>
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">제목</label>
			<div class="control-field">
			<input type=text name=title id=title value="${bPost.title}" maxlength=128>
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">내용</label>
			<div class="control-field">
			<textarea class="textfull" rows=10 cols=50 name=content id=content>${bPost.content}</textarea>
			</div>
		</div>
	</div>
	...
	<div class="myp-form-wrap">
		<p class="form-title3">수정시각 | ${bPost.updated}</p>
	</div>
