...
<tr><td>제목</td><td><input type=text name=title id=title value="${rPost.title}" maxlength=128></td></tr>
<tr><td>내용</td><td><textarea rows=10 cols=50 name=content id=content>${rPost.content}</textarea></td></tr>
<tr><td>작성자</td><td>${rPost.write}</td></tr>
