...
<body>
<table>
<form method="post" action="/modify3" id=frmUpdate name=frmUpdate>
<input type=hidden id=no name=num value='${qPost.num}'>
<div class="myp-form-wrap">
	<p class="form-title2">작성시각 | ${qPost.created}</p>
	<div class="myp-form-col">
		<div class="input-group inline">
			<label class="control-label2">게시물 번호</label>
			<div class="static-field">
			<input type="text" class="inputcolor" name="hp_tail1" id=num readonly value="${qPost.num}">
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">작성자</label>
			<div class="control-field">
			<input type=text class="inputcolor" name="hp_tail1" id=title value="${qPost.writer}" readonly>
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">조회수</label>
			<div class="control-field">
			<input type=text class="inputcolor" name="hp_tail1" id=title value="${qPost.hit}" readonly>
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">제목</label>
			<div class="control-field">
			<input type=text name=title id=title value="${qPost.title}" maxlength=128>
			</div>
		</div>
		<div class="input-group inline">
			<label class="control-label2">내용</label>
			<div class="control-field">
			<textarea class="textfull" rows=10 cols=50 name=content id=content>${qPost.content}</textarea>
			</div>
		</div>
	</div>
	...
	<div class="myp-form-wrap">
		<p class="form-title3">수정시각 | ${qPost.updated}</p>
	</div>
