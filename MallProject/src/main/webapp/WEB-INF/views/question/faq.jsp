...
<a href="/profile?id=${id}"><span style="color:#3498db;">내 정보 관리&nbsp;바로 가기</span></a></strong><br />
&nbsp;</p>
							</div>
						</div>
					</div>
...
<br />
<a href="/questionwrite"><span style="color:#3498db;"><strong>[상품문의 작성 바로 가기]</strong></span></a><br />
<br />
...
<br />
■<strong> <a href="/delivery"><span style="color:#3498db;">배송지 관리</span></a><span style="color:#3498db;"> </span></strong>경로&nbsp;<br />
모바일(앱/웹) : 마이페이지 > 내 정보 관리(오른쪽 위 톱니바퀴) > 배송지 관리<br />
PC(웹) : 마이페이지 > 배송지 관리<br />
<br />
...
<br />
<a href="/questionwrite"><span style="color:#3498db;"><strong>[1:1 문의 바로 가기]</strong></span></a></p>
							</div>
						</div>
					</div>
										<div class="CFaqTableItem ">
...
상품이 달라도 주문 시 한 번에 결제할 수 있습니다.&nbsp;<br />
<br />
아직 도착하지 않는 상품은 아래 경로에서 배송진행 상황을 확인해 주세요.&nbsp;<br />
<br />
■ 배송 조회 경로<br />
<a href="/orderList?id=${id}"><span style="color:#3498db;"><strong>마이페이지 > 주문/배송 조회</strong></span></a><br />
<br />
<a href="/orderList?id=${id}"><span style="color:#3498db;"><strong>[배송조회 바로 가기]</strong></span></a><br />
&nbsp;</p>
							</div>
						</div>
					</div>
...
<a href="/orderList?id=${id}"><span style="color:#3498db;"><strong>[배송조회 바로 가기]</strong></span></a><br />
<br />
<img alt="" height="361" src="img/orderList1.png" style="float:left" width="328" /></p>
							</div>
						</div>
					</div>
										<div class="CFaqTableItem ">
...
<br />
						...
						<div class="CFaqTableItem__contents-box">
							<em class="CFaqTableItem__answer">답변</em>
							<div class="CFaqTableItem__contents">
								<p>마이 페이지 > 취소/반품/교환 조회에서 교환(환불) 요청한 상품에 반송장 입력해 주셔야 빠른 처리가 가능합니다.<br />
<br />
■ 반송장 입력하기<br />
...
<br />
<a href="/mypage?id=${id}"><span style="color:#3498db;"><strong>취소/반품/교환 조회 바로 가기</strong></span></a><br />
							</div>
						</div>
					</div>
										<div class="CFaqTableItem ">
...
※ 다른 상품으로 교환 희망 시 환불 후 재주문해 주세요.</p>
						...
						<div class="CFaqTableItem__contents-box">
							<em class="CFaqTableItem__answer">답변</em>
							<div class="CFaqTableItem__contents">
								<p>교환은 배송 완료 일자 포함 7일 이내일 경우에만 주문/배송 조회에서 접수 가능합니다.<br />
(예시 : 3월 8일 상품을 받으신 경우 3월 14일까지 교환 접수 가능)<br />
<br />
<span style="font-size:14px;">■ <a href="/orderList?id=${id}"><span style="color:#3498db;"><strong>교환 접수 경로</strong></span></a><br />
모바일(앱/웹): 마이페이지 > 주문/배송 조회 > 교환 요청<br />
PC(웹): 마이페이지 > 주문 내역 조회 > 교환 요청<br />
<br />
1. 반품할 상품의 교환을 선택 해주세요.<br />
<br />
2. 반품 방법을 선택해 주세요.<br />
- 회수해 주세요 : Weverse는 자동회수 서비스로 택배기사가 요청한 회수지로 평일 기준 1일 ~ 3일 이내 방문합니다.&nbsp;<br />
...
※ 회원님의 사유로 교환 진행중인 상품이 품절될 경우, 반품비가 발생될 수 있고 이를 제외한 결제 금액이 환불 처리됩니다.&nbsp;<br />
										...
										<div class="CFaqTableItem ">
						<div class="CFaqTableItem__list">
							<em class="CFaqTableItem__category">픽업 취소/환불</em>
							<p class="CFaqTableItem__question">Weverse 픽업 주문건을 취소(환불/교환) 하고 싶어요.</p>
						</div>
						<div class="CFaqTableItem__contents-box">
							<em class="CFaqTableItem__answer">답변</em>
							<div class="CFaqTableItem__contents">
...
※ 교환을 원하는 경우 환불 후 다시 주문해 주세요. (매장 방문 시, Weverse 온라인 스토어 > 상품 상세 페이지에서 재고 수량을 미리 확인 후 방문해 주세요.)<br />
<br />
※ 구매 확정 여부과 관계없이 픽업 완료일로부터 7일 경과 시 환불이 가능하지 않습니다.<br />
※ 픽업 완료일 기준으로 7일 시점에 자동으로 구매확정됩니다.<br />
<br />
<a href="/orderList?id=${id}"><span style="color:#3498db;"><strong>주문/배송 조회 바로 가기</strong></span></a><br />
...
<br />
■ <a href="/mypage?id=${id}"><span style="color:#3498db;"><strong>환불 접수 경로</strong></span></a><br />
...
<br />
						...
						<div class="CFaqTableItem__contents-box">
							<em class="CFaqTableItem__answer">답변</em>
							<div class="CFaqTableItem__contents">
								<p>후기는 일반 후기, 상품 사진 후기 구성되어 있고 작성 시 적립금이 지급됩니다.<br />
...
&nbsp;&nbsp;&nbsp;또한, 해당 후기 종류에 지급되는 최대 적립금의 2배 회수 및 서비스 이용이 1년간 정지됩니다.<br />
<br />
■ 참고 사항<br />
- 작성한 후기는 Weverse 이용자에게 공개되며, 다른 회원이 댓글을 작성할 수 있습니다.<br />
- 작성된 후기는 Weverse 홍보 콘텐츠로 사용될 수 있습니다.<br />
<br />
</p>
							</div>
						</div>
						...
						<div class="CFaqTableItem__list">
							...
							<p class="CFaqTableItem__question">상품이 불량인 것을 사용 하고나서 확인했어요 어떻게 하나요?</p>
						</div>
						<div class="CFaqTableItem__contents-box">
							<em class="CFaqTableItem__answer">답변</em>
							<div class="CFaqTableItem__contents">
...
* 미 사용 상태에서 불량 확인 시, 무상으로 환불 및 교환 처리가 가능합니다.<br />
<br />
</p>
							</div>
						</div>
						...
						<div class="CFaqTableItem__list">
							...
							<p class="CFaqTableItem__question">쿠폰은 언제나 사용할 수 있나요?</p>
						</div>
						<div class="CFaqTableItem__contents-box">
							<em class="CFaqTableItem__answer">답변</em>
							<div class="CFaqTableItem__contents">
								<p>쿠폰은 항상 사용이 가능합니다.<br />
<br />
■ 쿠폰 사용이 되지 않을 경우<br />
- 바로 접속 OFF일 경우 구폰 사용이 제한됩니다.&nbsp;<br />
- 바로 접속 ON으로 변경 방법: 실행된 브라우저를 모두 종료 후 Weverse URL 주소를 직접 입력하여 접속해 주세요.<br />
- 일부 상품의 경우 본사 또는 브랜드 정책상 쿠폰 사용이 가능하지 않을 수 있습니다. 쿠폰 사용이 가능하지 않은 상품은 주문 작성 페이지에서 확인 가능합니다.</p>
							</div>
						</div>
					</div>
										<div class="CFaqTableItem ">
						<div class="CFaqTableItem__list">
							<em class="CFaqTableItem__category">혜택</em>
							<p class="CFaqTableItem__question">환불 시 사용한 쿠폰은 어떻게 반환되나요</p>
						</div>
						<div class="CFaqTableItem__contents-box">
							<em class="CFaqTableItem__answer">답변</em>
							<div class="CFaqTableItem__contents">
								<p>주문 시 사용한 쿠폰은 상품을 환불할 경우 다시 반환됩니다.<br />
부분 환불 시 사용한 쿠폰의 비율만큼 반환됩니다.<br />
<br />
■ 부분 환불 예시&nbsp;<br />
A 상품 - 30,000원 / B 상품 - 50,000원 / C 상품 - 70,000원을 구매할 때 사용한 쿠폰이 10,500원(구매 금액의 7%)일 경우,&nbsp;<br />
- A 상품 취소 시 30,000원의 7%인 2,100원의 쿠폰 반환, 차액 27,900원 환불&nbsp;<br />
- B 상품 취소 시 50,000원의 7%인 3,500원의 쿠폰 반환, 차액 46,500원 환불<br />
- C 상품 취소 시 70,000원의 7%인 4,900원의 쿠폰 반환, 차액 65,100원 환불</p>
							</div>
						</div>
					</div>
