...
<link rel="preload" href="/_next/static/css/2d6b571bdba4373a.css" as="style"/>
<link rel="stylesheet" href="/_next/static/css/2d6b571bdba4373a.css" data-n-g=""/>
...
<div class="sc-fdeced8b-0 bQTewR">
	...
	<img src="img/weverslogo.jpg" alt="weverse account" class="sc-b9ce515e-1 eFotTF"/></div>
	</div>
<div class="sc-fdeced8b-3 fuepEy">
<h1 class="sc-abf9608-0 gherQT">Welcome to weverse shop</h1>
...
<hr class="sc-ed52fcbe-2 bVlPDx"/></div>

</div><button type="button" class="sc-763a3587-1 frWBac" id=login>
